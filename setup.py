...
def Generate_Name_List(d):
    '''
    Builds lists of normalized names for HUE rooms/sensors/etc.

    Also populates the Dictionary's "obj_lookup" table with name/object pairs under the 
    correct category.

    Finally, creates file of all names of HUE objects/devices for use in events.
    '''
